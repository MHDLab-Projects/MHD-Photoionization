...
new_kwt = [round(v*1,5) for v in da_ct.coords['kwt'].values]
# new_kwt = sorted(new_kwt)
...
# %%
g = ds_alpha[['alpha','alpha_fit']].to_array('var').plot(col='kwt',hue='var', ylim = (1e-3,2), yscale='log', col_wrap=3
                                                         )
