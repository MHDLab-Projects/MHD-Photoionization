...
ds_mp['led_off'].mean('mnum').plot(hue='pos')
...
g = ds_mp.to_array('var').sel(wavelength=slice(700,785)).mean('mnum').plot(hue='pos', row='var', sharey=False)
...
# %%
g = ds_alpha[['alpha','alpha_fit']].to_array('var').plot(col='pos',hue='var', ylim = (1e-3,2), yscale='log', figsize=(10,6), col_wrap=3)
