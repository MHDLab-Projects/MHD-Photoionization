...
process_fns = [fn for fn in os.listdir(lecroy_munged_folder) if 'Silicon' not in fn]
process_fns = [fn for fn in process_fns if 'Nothing' not in fn]
process_fns = [fn for fn in process_fns if os.path.isfile(os.path.join(lecroy_munged_folder, fn))]
...
process_fns = [fn for fn in os.listdir(lecroy_munged_folder) if fn in process_fns]
