...
da_fit = da_fit/da_fit.mwt._pulse_max()
...
da_fit_norm = da_fit/da_fit.mwt._pulse_max()

# ds_mwt_fit = xr.merge([ds_mwt_fit, da_fit_norm.rename('AS_all')])

#%%

ds_mwt_fit.to_array('var').plot(x='time', row='run', hue='var')
...
ds = ds_mwt_fit.sel(run=('2023-05-24', 1))
...
plt.savefig(pjoin(DIR_FIG_OUT, 'fit_mwt_dnedt.png'), bbox_inches='tight')
...
plt.savefig(pjoin(DIR_FIG_OUT, 'fit_mwt_exp.png'))
...
plt.savefig(pjoin(DIR_FIG_OUT, 'fit_mwt_dnedt_v2.png'))
