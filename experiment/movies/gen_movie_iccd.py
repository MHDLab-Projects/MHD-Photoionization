...
def gen_movie_iccd(da_sel_tf, fp_out, duration):
    ...
    def make_frame(t):
        ...
        da_sel.plot(ax=ax, x='x', y='y', vmin=0, vmax=500)
        ax.set_title(f'Optical Emission\nGate Delay: {nearest_time} ns')
...
gen_movie_iccd(da_sel_tf, fp_out, duration=2.5)
# %%
