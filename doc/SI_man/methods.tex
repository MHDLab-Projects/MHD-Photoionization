...
We noted the most stable result in \cite{mohamedInfluenceSurfactantStructure2017a} “reproduced” it using a potassium carbonate brine, kerosene, and a SPAN 80 / TWEEN 80 surfactant blend meeting their recommended HLB of 6.8. The concentration of the surfactant was 0.5\% of the emulsion by volume - the minimum necessary found in \cite{mohamedInfluenceSurfactantStructure2017a} to obtain a stable emulsion. (Mohamed et al. measured ~5\% of liquid came out of emulsion in 100 minutes at 120 °C).  
...
\caption{Schematic of the emulsion preparation process.}
\label{fig:SI_Emulsion_Process}
\end{figure}


The following emulsion recipe was used. The mass density (rho) was measured by withdrawing a sample (about 10 ml) of emulsion and weighing it. 
...
\hline
\end{tabular}
\caption{Emulsion Recipe. M = mass. $rho_m$ is the measured mass density. $M_{total}$ is the calculated total mass. $f_{fuel}$ and $f_{K2CO3}$ are the calculated mass fraction of fuel and $K_2CO_3$, respectively.  }
