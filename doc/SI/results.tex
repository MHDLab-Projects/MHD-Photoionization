...
\begin{figure}[]
\centering
\includegraphics[width=0.8\textwidth]{\repodir/experiment/analysis/tcs/output/figures/5x6_pos_mwt_AStime_phi.png}
...
\caption{516 and 536 MWT AS exponential time constant comparison.}
\label{fig:SI_516_mwt_decaytime}
\end{figure}
...
\begin{figure}[h]
    \includegraphics[width=0.8\linewidth]{\repodir/final/figures/SI/output/Power_MWT.png} 
...
% final\analysis\output\figures\cfd_species_tau_pos.png

\begin{figure}[h]
    \includegraphics[width=0.8\linewidth]{\repodir/final/analysis/output/figures/cfd_species_tau_pos.png} 
...
\begin{figure}[h]
    \includegraphics[width=0.8\linewidth]{\repodir/final/analysis/output/figures/cfd_species_charged_sigma_pos.png} 
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{\repodir/final/analysis/mwt/output/figures/AS_fft.png} 
...
\begin{figure}[]
\centering
\includegraphics[width=0.7\textwidth]{\repodir/final/analysis/mwt/output/figures/dAS_max_notorch_compare.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{\repodir/experiment/analysis/mwt/output/figures/mwt_fitting_compare.png}
