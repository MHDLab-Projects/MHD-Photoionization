...
\begin{figure}
    ...
    \caption{ICCD camera images taken at 1\% potassium mass fraction in the Run 53x on 2023-05-24. During this test case the camera acquired 15 gate delay sweeps, which are averaged for these images. A) Images are taken at different gate delays. The laser is positioned at the SFR-maximized position. }
...
Figure \ref{fig:SI_fit_mwt_decay_power} shows the exponential time constant of the MWT signal as a function of laser power. The measurement is unreliable at low laser power, appears to be independent of the power for higher laser powers.
