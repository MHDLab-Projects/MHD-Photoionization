...
\begin{figure}[]
\centering
\includegraphics[width=0.7\textwidth]{\repodir/final/dataset/output/figures/536_pos_phi08_aas_fit.png}
...
\begin{figure}[]
\centering
\includegraphics[width=0.7\textwidth]{\repodir/final/dataset/output/figures/516_pos_phi06_aas_fit.png}
...
\begin{figure}[]
\centering
\includegraphics[width=0.7\textwidth]{\repodir/final/dataset/output/figures/53x_aas_fit.png}
