...
\clearpage
\subsection{Microwave Scattering (MWT) }
...
\begin{figure}[]
\centering
\includegraphics[width=0.8\textwidth]{\repodir/experiment/analysis/mwt/output/figures/mwt_processing_overview.png}
...
\begin{figure}[]
\centering
\includegraphics[width=0.8\textwidth]{\repodir/final/dataset/output/figures/mwt_nothing_time_trace_2023-05-18.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{\repodir/final/dataset/output/figures/mwt_nothing_motor_2023-05-24.png}
