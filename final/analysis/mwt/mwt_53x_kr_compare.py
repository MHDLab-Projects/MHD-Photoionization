...
krm_eff = ds_p_stats['mwt_fit_krm_mean']
krm_eff.plot()
...
ds_species_decay = 1/(ds_p_stats['mwt_fit_decay_exp_mean'].pint.quantify('us')*ds_krb)
...
axes[0].set_title('Predicted density $k_{r,species}$ and $\\tau_{mwt}$')
...
ds_p_stats['mwt_fit_decay_exp_mean'].plot(marker='o', color='black', label='Experiment')
...
ds_p_stats['mwt_fit_decay_exp_mean'].plot(marker='o', label='experiment')
...
# Plot decay
ds_p_stats['mwt_fit_decay_exp_mean'].plot(ax=axes[0], marker='o')
axes[0].set_title('MWT Time constant')
