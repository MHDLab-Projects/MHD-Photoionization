...
ds_cfd_sel['nK_m3'].sel(offset=0).plot(color='black', label ='CFD centerline', linestyle='-.')
ds_cfd_sel['nK_m3'].sel(offset=0.3).plot(color='black', label ='CFD 3mm off centerline', linestyle='--')
