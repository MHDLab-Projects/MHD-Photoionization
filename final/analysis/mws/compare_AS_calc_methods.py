...
ds_sel = ds_mws_53x.sel(kwt=1, method='nearest').sel(run=('2023-05-18', 1))
...
from pi_paper_utils.constants import MAG_MWS_BLOCK
from pi_paper_utils.fileio import load_mws_T0



mag_0 = load_mws_T0().sel(date=('2023-05-18'))
time_window_delta=slice(-2,-1)
mag_block=MAG_MWS_BLOCK
